      ...
      <div className="home-footer">
        ...
        <div className="home-right2">
          <div className="home-list4">
            <span className="home-header26">Menu</span>
          ...
          <div className="home-list5">
            <span className="home-header27">Resources</span>
          ...
          <div className="home-list6">
            <span className="home-header28">Contact</span>
    ...
    scroll(direction);
      ...
      >
        <div data-thq="slider-wrapper" className="swiper-wrapper">
          ...
          <div
            data-thq="slider-slide"
            className="home-slider-slide8 swiper-slide"
          ></div>
          <div
            data-thq="slider-slide"
            className="home-slider-slide9 swiper-slide"
          ></div>
        </div>
        <div
          data-thq="slider-pagination"
